...
class _$AlbumTearOff {
  ...
  _Album call({required int userId, required int id, String? title}) {
    return _Album(
      userId: userId,
      id: id,
      title: title,
...
class _$_Album implements _Album {
  const _$_Album({required this.userId, required this.id, this.title});
...
abstract class _Album implements Album {
  const factory _Album({required int userId, required int id, String? title}) =
      _$_Album;
